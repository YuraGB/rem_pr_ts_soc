...
Command: npx gltfjsx@6.2.14 .\public\assets\planet_earth\scene.gltf -o .\app\components\homePageComponent\Scene2.jsx -r .\public\assets\planet_earth\ 
...
export function Earth() {
  ...
  const { nodes, materials, animations } = useGLTF(
    "/assets/planet_earth/scene.gltf"
  );
  // @ts-ignore
...
useGLTF.preload("/assets/planet_earth/scene.gltf");
